...
$title = "Ganti Password - Ma'had Tsurayya";
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 row">
                            <div class="col-7">
                                ...
                                <input type="password" class="form-control" id="confPass" name="confPass" minlength="4" maxlength="20" placeholder="Ulangi password baru Anda" required>
                            </div>
                        </div>
                    </div>
                </div>
