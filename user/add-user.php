...
// =memerlukan_1x --> perintah yang digunakan untuk memasukkan file lain    

$title = "Tambah user - Ma'had Tsurayya";
                    ...
                    <div class="row">
                        <div class="col-8 col-sm-8 col-md-8 col-lg-8">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9" pattern="[A-Za-z0-9]{3,}" title="minimal 3 karakter kombinasi huruf besar, huruf kecil dan angka" style="margin-left: -50px;">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9" style="margin-left: -50px;">
                                    <input type="text" class="form-control border-0 border-bottom" id="nama" name="nama" maxlength="20" required> <!-- = dibutuhkan. Harus diisi -->
                                </div>
                            </div>
                            <div class="mb-3 row">
                        ...
                        <div class="col-4 col-sm-4 col-md-4 col-lg-4 text-center px-5">
