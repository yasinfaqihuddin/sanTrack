...
$title = "Update Santri - Ma'had Tsurayya";
                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <select name="jurusan" id="jurusan" class="form-select border-0 border-bottom" required>
                                            <?php
                                            $jurusan = ["Ilmu Al-Quran", "Bahasa Arab"];
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <textarea name="alamat" id="alamat" cols="30" rows="3" placeholder="alamat santri" class="form-control" required><?= $data['alamat'] ?></textarea>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <input type="text" name="walsan" required class="form-control border-0 border-bottom ps-2" id="walsan" value="<?= $data['walsan'] ?>">
                                    </div>
                                </div>
                            </div>
