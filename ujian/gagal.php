...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Gagal Ujian</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
                <li class="breadcrumb-item active">Data Siswa Gagal Ujian</li>
            </ol>
            <div class="card">
                <div class="card-header">
                    <i class="fa-solid fa-list"></i> Data Siswa Gagal Ujian
                </div>
                <div class="card-body">
                    <table class="table table-hover" id="datatablesSimple">
                        ...
                        <tbody>
                            <?php
                            $queryLulus = mysqli_query($koneksi, "SELECT * FROM tbl_ujian WHERE hasil_ujian = 'GAGAL'");
                            while ($data = mysqli_fetch_array($queryLulus)) { ?>
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-danger btn-sm rounded-0 col-10 fw-bold text-uppercase"><?= $data['hasil_ujian'] ?></button></td>
                                </tr>
